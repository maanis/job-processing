...
import { downloadAdminProcessedRows, downloadAdminFailedRows } from '@/services/api';
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-12 flex flex-col items-center justify-center">
                    ...
                    <div className="w-full max-w-2xl space-y-6 animate-in fade-in zoom-in-95 duration-500">
                        ...
                        <div className="text-center space-y-2 mb-8">
                            <h2 className="text-3xl font-bold tracking-tight">System Exports</h2>
                            <p className="text-muted-foreground">Download logs and processed data reports.</p>
                        </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            <Chip label="Today" onClick={() => handlePresetClick(0)} active={false} />
                                            <Chip label="Last 7 Days" onClick={() => handlePresetClick(7)} active={false} />
                                            <Chip label="Last 30 Days" onClick={() => handlePresetClick(30)} active={false} />
                                            <Chip label="Last 3 Months" onClick={() => handlePresetClick(90)} active={false} />
                                        </div>
                                    </div>
                                </div>
...
function ActionButton({ label, subLabel, icon: Icon, loading, disabled, onClick, variant }: any) {
    ...
    return (
        <button
            ...
            className={cn(
                ...
                // Hover States
                !disabled && !isDestructive && "hover:border-primary/50 hover:bg-primary/5 hover:shadow-lg hover:shadow-primary/5 active:scale-[0.98]",
                !disabled && isDestructive && "hover:border-red-500/50 hover:bg-red-500/5 hover:shadow-lg hover:shadow-red-500/5 active:scale-[0.98]",
